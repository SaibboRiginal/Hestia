...
> Updated 2026-06-12 — post agent-loop unification and tool-calling refactor.
...
| `test_live_tool_calling_comprehensive.py` | 10 | llm_live | ⏳ Requires Ollama |
| **TOTAL** | **264** | **55% overall / 72%+ core** | ✅ |
