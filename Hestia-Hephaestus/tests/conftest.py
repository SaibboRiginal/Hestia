"""Hephaestus test suite conftest."""
from __future__ import annotations

import os
import sys

_HEPHAESTUS_ROOT = os.path.join(os.path.dirname(__file__), "..")
_HEPHAESTUS_APP = os.path.join(os.path.dirname(__file__), "..", "app")
_SHARED = os.path.join(os.path.dirname(__file__), "..", "..", "Hestia-Shared")
for _p in [_HEPHAESTUS_ROOT, _HEPHAESTUS_APP, _SHARED]:
